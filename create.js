...
btnCrear.onclick = async function (event) {
  ...
  // este objeto sera que el que enviaremos al API para que pueda crear una nueva pelicula
  const movie = {
  ...
  // Recuerden que es recomendable tener un try catch cuando hagamos una peticion
};